...
>> I have created an environment specifically for metis bootcamp with Python 3 and all the necessary packages installed. However, I do have access to Python 2 as well.
